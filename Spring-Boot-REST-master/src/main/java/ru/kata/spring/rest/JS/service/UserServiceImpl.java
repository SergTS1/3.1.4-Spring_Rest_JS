...
import ru.kata.spring.rest.JS.DAO.RoleDAO;
...
public class UserServiceImpl implements UserService {
    ...
    public void addDefaultUser() {
        ...
        User user1 = new User("Sergey","Zakirov",(byte) 34, "szakirov@mail.com", "root","1000",roles1);
        User user2 = new User("Natalia","Kravchenco",(byte) 37, "Natalia@mail.com", "user","user",roles2);
        save(user1);
        save(user2);
        }
}
